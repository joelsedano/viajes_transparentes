	...
	public function editar_viaje($viaje = 0){
		...
		if($accion != ""){
			$datos = array(
				...
				'mecanismo_origen' => $this->input->post('mecanismo_origen'),
				...
				'cargo_funcionario' => $this->input->post('cargo_servidor'),
				'grupo_funcionario' => $this->input->post('grupo_servidor'),
				...
				'fecha_inicio' => fecha_sql($this->input->post('fecha_inicio')),
				'fecha_fin' => fecha_sql($this->input->post('fecha_fin')),
				...
				'aerolinea_ida' => $this->input->post('aerolinea_ida'),
				'num_vuelo_ida' => $this->input->post('num_vuelo_ida'),
				'aerolinea_vuelta' => $this->input->post('aerolinea_vuelta'),
				'num_vuelo_vuelta' => $this->input->post('num_vuelo_vuelta'),
				'fecha_inicio_comision' => fecha_sql($this->input->post('fecha_inicio_comision')),
				'fecha_fin_comision' => fecha_sql($this->input->post('fecha_fin_comision')),
				...
				'fecha_entrada' => fecha_sql($this->input->post('fecha_entrada')),
				'fecha_salida' => fecha_sql($this->input->post('fecha_salida')),
				...
				'monto_viaticos_devueltos' => $this->input->post('monto_viaticos_devueltos'),
